...
// //Отрифосква фильтров-статуса
// render(siteMainElement,new SiteFilterStatsView(films), RenderPosition.AFTERBEGIN);
...
// render(siteFooterElement, new SiteFooterElementView(films), RenderPosition.BEFOREEND);
...
const appMovie = new MoviePresenter();
appMovie.init();
